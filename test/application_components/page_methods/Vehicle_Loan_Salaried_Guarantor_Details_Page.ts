...
export class Vehicle_Loan_Salaried_Guarantor_Details_Page {
  private page: Page;
...
//1.Guarantor Address Proof Details
...
//1.Guarantor Employment Details
readonly btn_add_data_button_for_1_gurantor_employment_details: Locator;
readonly txt_name_of_the_firm_for_gurantor_employment_details: Locator;
readonly txt_address_of_the_firm_in_guarantor_salary_details: Locator;
readonly designation: Locator;
  ...
  readonly btn_verify_button_for_guarantor_employment_details: Locator;

  //1.Guarantor Company ID Details
 readonly btn_add_data_button_for_guarantor_1_company_id_details: Locator;
 readonly txt_company_name_in_guarantor_1_company_id_details: Locator;
 readonly txt_address_in_guarantor_1_company_id_details: Locator;
 readonly txt_employee_id_in_guarantor_1_company_id_details: Locator;
 readonly txt_employee_name_in_guarantor_1_company_id_details: Locator;
 readonly txt_joining_date_in_guarantor_1_company_id_details: Locator;
 readonly btn_save_button_for_gurantor_1_company_id_details: Locator;
 readonly btn_verify_button_for_guarantor_1_company_id_details: Locator;

 //1.Guarantor Bank Statement Details
 readonly btn_add_data_button_for_guarantor_1_bank_statement_details: Locator;
 readonly btn_add_a_line_button_for_guarantor_1_bank_statement_details: Locator;
 readonly txt_name_in_guarantor_1_bank_statement_details: Locator;
 readonly txt_account_number_in_guarantor_1_bank_statement_details: Locator;
 readonly txt_bank_balance_in_guarantor_1_bank_statement_details: Locator;
 readonly txt_average_balance_in_guarantor_1_bank_statement_details: Locator;
 readonly txt_cb_mbc_ac_ecs_si_in_guarantor_1_bank_statement_details: Locator;
 readonly btn_save_button_for_gurantor_1_bank_statement_details: Locator;
 readonly btn_verify_button_for_guarantor_1_bank_statement_details: Locator;

 //Guarantor1 Other Income Details 
 readonly btn_add_data_button_for_guarantor_1_other_income_details: Locator;
 readonly btn_add_a_line_button_for_guarantor_1_other_income_details: Locator;
 readonly txt_month_in_guarantor_1_other_income_details: Locator;
 readonly txt_amount_in_guarantor_1_other_income_details: Locator;
 readonly txt_total_amount_in_guarantor_1_other_income_details: Locator;
 readonly btn_save_button_for_gurantor_1_other_income_details: Locator;
 readonly btn_verify_button_for_guarantor_1_other_income_details: Locator;

 //1.Guarantor Salary Credit Bank Account
 readonly btn_add_data_button_for_guarantor_1_salary_credit_bank_account: Locator;
 readonly btn_add_a_line_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly txt_bank_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly txt_branch_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly txt_account_number_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly txt_account_opening_date_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly txt_type_of_account_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly txt_salary_credit_account_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly btn_save_button_for_guarantor_1_salary_credit_bank_details: Locator;
 readonly btn_verify_button_for_guaranter_1_salary_credit_bank_details: Locator;

 //1.Guarantor Form 16 Details
 readonly btn_verify_button_for_guarantor_1_form_16_details: Locator;

 //1.Guarantor Membership Details
 readonly btn_add_data_button_for_guarantor_1_membership_details: Locator;
 readonly txt_guarantor_membership_number_for_guarantor_1_membership_details: Locator;
 readonly txt_guarantor_number_of_shares_for_guarantor_1_membership_details: Locator;
 readonly txt_guarantor_shares_from_guarantor_1_membership_details: Locator;
 readonly txt_guarantor_existing_shares_amount_from_guarantor_1_membership_details: Locator;
 readonly txt_guarantor_total_shares_required_from_guarantor_1_membership_details: Locator;
 readonly txt_guarantor_additional_shares_required_from_guarantor_1_membership_details: Locator;
 readonly btn_save_button_for_guarantor_1_membership_details: Locator;
 readonly btn_verify_button_for_guarantor_1_membership_details: Locator;

 //2. Guarantor ID Proof Details
 readonly guarantor_2_ID_proof_details_add_data_btn:Locator;
  readonly guarantor_2_first_name_id_document:Locator;
  readonly guarantor_2_pan_name_id_document:Locator;
  readonly save_btn_guarantor_2_iddoc_details:Locator;
  readonly guarantor_2_eye_btn_pancard:Locator;
  readonly verify_btn_guarantor2_iddoc_details:Locator;


//2.Guarantor Address Proof Details
readonly add_data_btn_guarantors_2_address_proof_details:Locator;
readonly guarantors_2_address_proof_details_name_field:Locator;
readonly guarantors_2_address_proof_details_aadhar_doc_field:Locator;
readonly guarantors_2_address_proof_details_residence_address_document_field:Locator;
...
readonly joining_date_in_guarantor_2_salary_details:Locator;
 ...
 readonly txt_guarantor_basic_information_title: Locator;
 ...
 readonly btn_add_data_button_for_guarantor_company_id_details: Locator;
 readonly txt_company_name_in_guarantor_company_id_details: Locator;
 readonly txt_address_in_guarantor_company_id_details: Locator;
 readonly txt_employee_id_in_guarantor_company_id_details: Locator;
 readonly txt_employee_name_in_guarantor_company_id_details: Locator;
 readonly txt_joining_date_in_guarantor_company_id_details: Locator;
 readonly btn_save_button_for_gurantor_company_id_details: Locator;
 readonly btn_verify_button_for_guarantor_company_id_details: Locator;
 readonly btn_add_data_button_for_guarantor_bank_statement_details: Locator;
 readonly btn_add_a_line_button_for_guarantor_bank_statement_details: Locator;
 readonly txt_name_in_guarantor_bank_statement_details: Locator;
 readonly txt_account_number_in_guarantor_bank_statement_details: Locator;
 readonly txt_bank_balance_in_guarantor_bank_statement_details: Locator;
 readonly txt_average_balance_in_guarantor_bank_statement_details: Locator;
...
this.credit_bureau_title=this.page.locator("(//span[contains(text(),'Credit Bureau')])[2]")
 ...
 /******************** Page Objects for guarantor details ************************/

 //1.Gurantor Basic Information
...
//1.Gurantor ID Proof Details
    ...
    //1.Gurantor Address Proof Details
    ...
    //1.Gurantor Employment Details
    this.btn_add_data_button_for_1_gurantor_employment_details=this.page.locator("//button[@name='guarantor1_salary_details_wizard']//span[contains(text(),'Add Data')]")
    this.txt_name_of_the_firm_for_gurantor_employment_details=this.page.locator("//input[@name='wizard_guarantor1_company_where_employed']")
    this.txt_address_of_the_firm_in_guarantor_salary_details=this.page.locator("//input[@name='wizard_guarantor1_address_of_the_firm']")
    this.designation= this.page.locator("//select[@name='wizard_guarantor1_designation']");
    this.type_of_organization= this.page.locator("//select[@name='wizard_guarantor1_type_of_organisation']");
    this.joining_date= this.page.locator("//input[@name='wizard_guarantor1_since_date']");
    this.Remark= this.page.locator("//input[@name='wizard_guarantor1_remarks']")

    this.salary_details_add_line_btn= this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor1_salary_details_ids']//*[contains(text(),'Add a line')]")
    this.salary_details_month = this.page.locator("//select[@name='wizard_guarantor1_month']");
    this.salary_details_year= this.page.locator("//select[@name='wizard_guarantor1_year']");
    this.gross_salary= this.page.locator("//input[@name='wizard_guarantor1_gross_salary']");
    this.deduction= this.page.locator("//input[@name='wizard_guarantor1_deductions']");
    this.net_salary= this.page.locator("//span[@name='wizard_guarantor1_net_salary']");
    this.salary_credited_date= this.page.locator("//input[@name='wizard_guarantor1_salary_credited_date']");
    this.pf= this.page.locator("//input[@name='wizard_pf']");
    this.salary_slip_save_btn= this.page.locator("//button[@name='save_guarantor1_salary_slip']");
    this.btn_verify_button_for_guarantor_employment_details=this.page.locator("//*[text()='1. Guarantor Employment Details']/ancestor::h1//*[text()='Verify']")


    //1.Gurantor Company ID Details
    this.btn_add_data_button_for_guarantor_1_company_id_details=this.page.locator("//button[@name='guarantor1_company_id_details_wizard']//span[contains(text(),'Add Data')]")
    this.txt_company_name_in_guarantor_1_company_id_details=this.page.locator("//input[@name='wizard_guarantor1_first_name_company_document']")
    this.txt_address_in_guarantor_1_company_id_details=this.page.locator("//input[@name='wizard_guarantor1_address_details']")
    this.txt_employee_id_in_guarantor_1_company_id_details=this.page.locator("//input[@name='wizard_guarantor1_employee_id']")
    this.txt_employee_name_in_guarantor_1_company_id_details=this.page.locator("//input[@name='wizard_guarantor1_employee_name']")
    this.txt_joining_date_in_guarantor_1_company_id_details=this.page.locator("//input[@name='wizard_guarantor1_joining_date']")
    this.btn_save_button_for_gurantor_1_company_id_details=this.page.locator("//button[@name='save_guarantor1companyiddoc_details']")
    this.btn_verify_button_for_guarantor_1_company_id_details=this.page.locator("//*[text()='1. Guarantor Company ID Details']/ancestor::h1//*[text()='Verify']")

    //1.Guarantor Bank Statement Details
    this.btn_add_data_button_for_guarantor_1_bank_statement_details=this.page.locator("//button[@name='guarantor1_bank_statement_wizard']//span[contains(text(),'Add Data')]")
    this.btn_add_a_line_button_for_guarantor_1_bank_statement_details=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor1_bank_statement_ids']//*[contains(text(),'Add a line')]")
    this.txt_name_in_guarantor_1_bank_statement_details=this.page.locator("//input[@name='wizard_name']")
    this.txt_account_number_in_guarantor_1_bank_statement_details=this.page.locator("//input[@name='wizard_ac_no']")
    this.txt_bank_balance_in_guarantor_1_bank_statement_details=this.page.locator("//input[@name='wizard_bank_balance']")
    this.txt_average_balance_in_guarantor_1_bank_statement_details=this.page.locator("//input[@name='wizard_avg_balance']")
    this.txt_cb_mbc_ac_ecs_si_in_guarantor_1_bank_statement_details=this.page.locator("//input[@name='wizard_cb_mbc_ac_ecs_si']")
    this.btn_save_button_for_gurantor_1_bank_statement_details=this.page.locator("//button[@name='save_guarantor1_bank_statement_wizard']")
    this.btn_verify_button_for_guarantor_1_bank_statement_details=this.page.locator("//*[text()='1. Guarantor Bank Statement Details']/ancestor::h1//*[text()='Verify']")

    //Guarantor1 Other Income Details
    this.btn_add_data_button_for_guarantor_1_other_income_details=this.page.locator("//button[@name='guarantor1_other_income_wizard']//span[contains(text(),'Add Data')]")
    this.btn_add_a_line_button_for_guarantor_1_other_income_details=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor1_other_income_ids']//*[contains(text(),'Add a line')]")
    this.txt_month_in_guarantor_1_other_income_details=this.page.locator("//select[@name='wizard_month']")
    this.txt_amount_in_guarantor_1_other_income_details=this.page.locator("//input[@name='wizard_amount']")
    this.txt_total_amount_in_guarantor_1_other_income_details=this.page.locator("//span[@name='wizard_guarantor1_other_income_total_amount']")
    this.btn_save_button_for_gurantor_1_other_income_details=this.page.locator("//button[@name='save_guarantor1_other_income_wizard']")
    this.btn_verify_button_for_guarantor_1_other_income_details=this.page.locator("//*[text()='Guarantor1 Other Income Details']/ancestor::h1//*[text()='Verify']")

    //1.Guarantor Salary Credit Bank Account
    this.btn_add_data_button_for_guarantor_1_salary_credit_bank_account=this.page.locator("//button[@name='guarantor1_salary_credit_bank_wizard']//span[contains(text(),'Add Data')]")
    this.btn_add_a_line_for_guarantor_1_salary_credit_bank_details=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor1_salary_credit_ids']//*[contains(text(),'Add a line')]")
    this.txt_bank_for_guarantor_1_salary_credit_bank_details=this.page.locator("//input[@name='wizard_bank_name']")
    this.txt_branch_for_guarantor_1_salary_credit_bank_details=this.page.locator("//input[@name='wizard_branch_name']")
    this.txt_account_number_for_guarantor_1_salary_credit_bank_details=this.page.locator("//input[@name='wizard_account_number']")
    this.txt_account_opening_date_for_guarantor_1_salary_credit_bank_details=this.page.locator("//input[@name='wizard_doc_acc_opening_date']")
    this.txt_type_of_account_for_guarantor_1_salary_credit_bank_details=this.page.locator("//select[@name='wizard_account_type']")
    this.txt_salary_credit_account_for_guarantor_1_salary_credit_bank_details=this.page.locator("//input[@name='wizard_doc_salary_credit_amt']")
    this.btn_save_button_for_guarantor_1_salary_credit_bank_details=this.page.locator("//button[@name='save_guarantor1_salary_credit']")
    this.btn_verify_button_for_guaranter_1_salary_credit_bank_details=this.page.locator("//*[text()='1. Guarantor Salary Credit Bank Account']/ancestor::h1//*[text()='Verify']")

    //1.Guarantor Form 16 Details
    this.btn_verify_button_for_guarantor_1_form_16_details=this.page.locator("//*[text()='1. Guarantor Form 16 Details']/ancestor::h1//*[text()='Verify']")

    //1.Guarantor Membership Details
    this.btn_add_data_button_for_guarantor_1_membership_details=this.page.locator("//button[@name='guarantor_membership_details_wizard']//span[contains(text(),'Add Data')]")
    this.txt_guarantor_membership_number_for_guarantor_1_membership_details=this.page.locator("//input[@name='wizard_guarantor_membership_number']")
    this.txt_guarantor_number_of_shares_for_guarantor_1_membership_details=this.page.locator("//input[@name='wizard_guarantor_no_of_shares']")
    this.txt_guarantor_shares_from_guarantor_1_membership_details=this.page.locator("//input[@name='wizard_guarantor_share_from']")
    this.txt_guarantor_existing_shares_amount_from_guarantor_1_membership_details=this.page.locator("//input[@name='wizard_guarantor_existing_share_amt']")
    this.txt_guarantor_total_shares_required_from_guarantor_1_membership_details=this.page.locator("//input[@name='wizard_guarantor_total_share_req']")
    this.txt_guarantor_additional_shares_required_from_guarantor_1_membership_details=this.page.locator("//input[@name='wizard_guarantor_additional_share_req']")
    this.btn_save_button_for_guarantor_1_membership_details=this.page.locator("//button[@name='save_guarantor_membership_details']")
    this.btn_verify_button_for_guarantor_1_membership_details=this.page.locator("//*[text()='Guarantor Membership Details']/ancestor::h1//*[text()='Verify']")


    
//2.Gurantor ID Proof Details

    this.guarantor_2_ID_proof_details_add_data_btn=this.page.locator('//button[@name="guarantors1_id_proof_details_wizards"]')
    this.guarantor_2_first_name_id_document=this.page.locator('//input[@name="wizard_guarantor2_first_name_id_document"]')        
    this.guarantor_2_pan_name_id_document=this.page.locator('//input[@name="wizard_guarantor2_pan_document"]')
    this.save_btn_guarantor_2_iddoc_details=this.page.locator('//button[@name="save_guarantor2iddoc_details"]')
    this.guarantor_2_eye_btn_pancard=this.page.locator('(//button[@name="toggle_guarantor2_pan_visibility"])[1]')
    this.verify_btn_guarantor2_iddoc_details=this.page.locator('//div[@name="verify_guarantor2_id_proof_details"]')

     //2.Gurantor Address Proof Details
    this.add_data_btn_guarantors_2_address_proof_details=this.page.locator('//button[@name="guarantors2_address_proof_details_wizards"]')
    this.guarantors_2_address_proof_details_name_field=this.page.locator('//input[@name="wizard_guarantor2_first_name_address_document"]')
    this.guarantors_2_address_proof_details_aadhar_doc_field=this.page.locator('//input[@name="wizard_guarantor2_aadhaar_document"]')
    this.guarantors_2_address_proof_details_residence_address_document_field=this.page.locator('//input[@name="wizard_guarantor2_residence_address_document"]')
    this.guarantors_2_address_proof_details_dob_field=this.page.locator('//input[@name="wizard_guarantor2_dob_document"]')
    this.save_btn_guarantors_2_address_proof_details=this.page.locator('//button[@name="save_guarantor2addressdoc_details"]')
    ...
    this.txt_guarantor_basic_information_title=this.page.locator("//div[@id='notebook_page_17744']//span[contains(text(),'1.Guarantor Basic Information')]")
    this.btn_guarantor_computation_of_income_add_data_button=this.page.locator("//button[@name='guarantor2_computation_income_details_wizard']//span[contains(text(),'Add Data')]")
    ...
    this.btn_save_button_for_guarantor_computation_income_details=this.page.locator("//button[@name='save_guarantor2_computation_income_wizard']")
    this.btn_verify_button_for_gurantor_computation_of_income=this.page.locator("//*[text()='2. Guarantor Computation of Income']/ancestor::h1//*[text()='Verify']")
    this.btn_add_data_button_for_guarantor_business_details=this.page.locator("//button[@name='guarantor2_business_details_wizard']//span[contains(text(),'Add Data')]")
    this.txt_name_of_the_firm_for_for_gurantor_business_details=this.page.locator("//input[@name='wizard_guarantor2_business_name']")
    this.txt_address_of_the_firm=this.page.locator("//input[@name='wizard_guarantor2_business_address']")
    this.txt_type_of_ownership=this.page.locator("//input[@name='wizard_guarantor2_ownership']")
    this.txt_nature_of_business_in_detail=this.page.locator("//input[@name='wizard_guarantor2_nature_of_business']")
    this.btn_add_a_line_button_for_guarantor_financials=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor2_business_details_ids']//*[contains(text(),'Add a line')]")
    ...
    this.btn_add_data_button_for_guarantor_company_id_details=this.page.locator("//button[@name='guarantor2_company_id_details_wizard']//span[contains(text(),'Add Data')]")
    this.txt_company_name_in_guarantor_company_id_details=this.page.locator("//input[@name='wizard_guarantor2_first_name_company_document']")
    this.txt_address_in_guarantor_company_id_details=this.page.locator("//input[@name='wizard_guarantor2_address_details']")
    this.txt_employee_id_in_guarantor_company_id_details=this.page.locator("//input[@name='wizard_guarantor2_employee_id']")
    this.txt_employee_name_in_guarantor_company_id_details=this.page.locator("//input[@name='wizard_guarantor2_employee_name']")
    this.txt_joining_date_in_guarantor_company_id_details=this.page.locator("//input[@name='wizard_guarantor2_joining_date']")
    this.btn_save_button_for_gurantor_company_id_details=this.page.locator("//button[@name='save_guarantor2companyiddoc_details']")
    this.btn_verify_button_for_guarantor_company_id_details=this.page.locator("//*[text()='2. Guarantor Company ID Details']/ancestor::h1//*[text()='Verify']")
    this.btn_add_data_button_for_guarantor_bank_statement_details=this.page.locator("//button[@name='guarantor2_bank_statement_wizard']//span[contains(text(),'Add Data')]")
    this.btn_add_a_line_button_for_guarantor_bank_statement_details=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor2_bank_statement_ids']//*[contains(text(),'Add a line')]")
    this.txt_name_in_guarantor_bank_statement_details=this.page.locator("//input[@name='wizard_name']")
    this.txt_account_number_in_guarantor_bank_statement_details=this.page.locator("//input[@name='wizard_ac_no']")
    this.txt_bank_balance_in_guarantor_bank_statement_details=this.page.locator("//input[@name='wizard_bank_balance']")
    this.txt_average_balance_in_guarantor_bank_statement_details=this.page.locator("//input[@name='wizard_avg_balance']")
    this.txt_cb_mbc_ac_ecs_si_in_guarantor_bank_statement_details=this.page.locator("//input[@name='wizard_cb_mbc_ac_ecs_si']")
    this.btn_save_button_for_gurantor_bank_statement_details=this.page.locator("//button[@name='save_guarantor2_bank_statement_wizard']")
    this.btn_verify_button_for_guarantor_bank_statement_details=this.page.locator("//*[text()='2. Guarantor Bank Statement Details']/ancestor::h1//*[text()='Verify']")
...
//Vehicle Loan Salaried Guarantor Details Page Methods
...
async user_clicks_add_data_button_for_guarantor_employment_details(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_1_gurantor_employment_details);
}

async user_enters_name_of_the_firm_in_guarantor_employment_details(strfirmname: string){
  await this.playwrightFactory.fill(this.txt_name_of_the_firm_for_gurantor_employment_details, strfirmname);
}

async user_enters_address_of_the_firm_in_guarantor_salary_details(straddresssalary: string){
  await this.playwrightFactory.fill(this.txt_address_of_the_firm_in_guarantor_salary_details, straddresssalary);
}
...
async user_click_verify_button_for_gurantor_employment_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guarantor_employment_details);
}

async user_clicks_add_data_button_for_guarantor_1_company_id_details(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_guarantor_1_company_id_details);
}

async user_enters_company_name_in_details_in_guarantor_1_company_id_details(strcompany: string){
  await this.playwrightFactory.fill(this.txt_company_name_in_guarantor_1_company_id_details, strcompany);
}

async user_enters_address_name_in_details_in_guarantor_1_company_id_details(straddresscompanyid: string){
  await this.playwrightFactory.fill(this.txt_address_in_guarantor_1_company_id_details, straddresscompanyid);
}

async user_enters_employee_id_in_details_in_guarantor_1_company_id_details(stremployeeid: string){
  await this.playwrightFactory.fill(this.txt_employee_id_in_guarantor_1_company_id_details, stremployeeid);
}

async user_enters_employee_name_in_details_in_guarantor_1_company_id_details(stremployeename: string){
  await this.playwrightFactory.fill(this.txt_employee_name_in_guarantor_1_company_id_details, stremployeename);
}

async user_selects_joining_date_in_guarantor_1_company_id_details(strjoiningdate: string) {
await this.playwrightFactory.fill(this.txt_joining_date_in_guarantor_1_company_id_details, strjoiningdate)
}

async user_clicks_save_button_for_guarantor_1_company_id_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_gurantor_1_company_id_details);
}

async user_clicks_verify_button_for_gurantor_1_company_id_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guarantor_1_company_id_details);
}

async user_clicks_add_data_button_for_guarantor_1_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_guarantor_1_bank_statement_details);
}

async user_clicks_add_a_line_button_for_guarantor_1_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_add_a_line_button_for_guarantor_1_bank_statement_details);
}
...
async user_clicks_save_button_for_guarantor_1_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_gurantor_1_bank_statement_details);
}

async user_clicks_verify_button_for_gurantor_1_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guarantor_1_bank_statement_details);
}

async user_clicks_add_data_button_for_guarantor_1_salary_credit_bank_account(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_guarantor_1_salary_credit_bank_account);
}

async user_click_add_a_line_button_for_guarantor_1_salary_credit_bank_details(){
  await this.playwrightFactory.click(this.btn_add_a_line_for_guarantor_1_salary_credit_bank_details);
}

async user_enters_bank_in_guarantor_1_salary_credit_bank_details(strbank: string){
  await this.playwrightFactory.fill(this.txt_bank_for_guarantor_1_salary_credit_bank_details, strbank);
}

async user_enters_branch_in_guarantor_1_salary_credit_bank_details(strbranch: string){
  await this.playwrightFactory.fill(this.txt_branch_for_guarantor_1_salary_credit_bank_details, strbranch);
}

async user_enters_account_number_in_guarantor_1_salary_credit_bank_details(straccountnumber: string){
  await this.playwrightFactory.fill(this.txt_account_number_for_guarantor_1_salary_credit_bank_details, straccountnumber);
}

async user_selects_account_opening_date_in_guarantor_1_salary_credit_bank_details(stropeningdate: string) {
await this.playwrightFactory.fill(this.txt_account_opening_date_for_guarantor_1_salary_credit_bank_details, stropeningdate)
}
...
async user_enters_salary_credit_amount_in_guarantor_1_salary_credit_bank_details(strcreditamount: string){
  await this.playwrightFactory.fill(this.txt_salary_credit_account_for_guarantor_1_salary_credit_bank_details, strcreditamount);
}

async user_clicks_save_button_for_guarantor_1_salary_credit_bank_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_guarantor_1_salary_credit_bank_details);
}

async user_clicks_verify_button_for_guarantor_1_salary_credit_bank_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guaranter_1_salary_credit_bank_details);
}

async user_clicks_verify_button_for_guarantor_1_form_16_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guarantor_1_form_16_details);
}

async user_clicks_add_data_button_for_guarantor_membership_details(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_guarantor_1_membership_details);
}

async user_enters_guaranter_membership_number_in_guarantor_membeership_details(strmembership: string){
  await this.playwrightFactory.fill(this.txt_guarantor_membership_number_for_guarantor_1_membership_details, strmembership);
}


 
async user_enters_number_of_shares_in_guarantor_membership_details(strnumber1:string){
  await this.playwrightFactory.fill(this.txt_guarantor_number_of_shares_for_guarantor_1_membership_details,strnumber1);
}
 
async user_enters_shares_from_in_guarantor_membership_details(strdate:string){
  await this.playwrightFactory.click(this.txt_guarantor_shares_from_guarantor_1_membership_details);
  await this.playwrightFactory.fill(this.txt_guarantor_shares_from_guarantor_1_membership_details,strdate);
}
 
async user_enters_existing_shares_amount_in_guarantor_membership_details(stramount: string){
  await this.playwrightFactory.fill(this.txt_guarantor_existing_shares_amount_from_guarantor_1_membership_details,stramount);
}
 
async user_enters_total_shares_required_in_guarantor_membership_details(strtotal:string){
  await this.playwrightFactory.fill(this.txt_guarantor_total_shares_required_from_guarantor_1_membership_details,strtotal);
}
async user_enters_additional_shares_required_in_guarantor_membership_details(stradditional: string){
  await this.playwrightFactory.fill(this.txt_guarantor_additional_shares_required_from_guarantor_1_membership_details,stradditional)
}
async user_clicks_save_button_in_guarantor_membership_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_guarantor_1_membership_details);
 
}
async user_clicks_verify_button_in_guarantor_membership_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guarantor_1_membership_details)
 
}


async user_clicks_add_data_button_of_guarantor_2_id_proof_details_field(){
  await this.guarantor_2_ID_proof_details_add_data_btn.click()
}
async user_enter_guarantor_2_first_name_id_document(strname: string) {
  await this.playwrightFactory.fill(this.guarantor_2_first_name_id_document, strname)
}
async user_enter_guarantor_2_pan_name_id_document(strname: string) {
  await this.playwrightFactory.fill(this.guarantor_2_pan_name_id_document, strname)
}
async user_click_save_btn_guarantor_2_iddoc_details(){
  await this.save_btn_guarantor_2_iddoc_details.click()
}
 
async user_click_guarantor_2_eye_btn_pan_card(){
  await this.eye_btn_pancard.click()
  await expect(this.guarantor_2_eye_btn_pancard).toBeVisible();
}
 
async user_click_verify_btn_guarantor_2_iddoc_details(){
  await this.verify_btn_guarantor2_iddoc_details.click()
}


async user_click_add_data_btn_guarantors_2_address_proof_details(){
  await this.add_data_btn_guarantors_2_address_proof_details.click()
}
 
async user_enter_name_in_guarantors_2_address_proof_details_field(strname: string){
  await this.playwrightFactory.fill(this.guarantors_2_address_proof_details_name_field, strname)
}
 
async user_enter_adhar_number_in_guarantors_2_address_proof_details_field(strname: string){
  await this.playwrightFactory.fill(this.guarantors_2_address_proof_details_aadhar_doc_field, strname)
}
 
async user_enter_residence_address_document_in_guarantors_2_address_proof_details_field(strname: string){
  await this.playwrightFactory.fill(this.guarantors_2_address_proof_details_residence_address_document_field, strname)
}
async user_enter_date_of_birth_in_guarantors_2_address_proof_details_field(strname: string){
  await this.playwrightFactory.fill(this.guarantors_2_address_proof_details_dob_field, strname)
}
 
async user_click_save_btn_guarantors_2_address_proof_details(){
  await this.save_btn_guarantors_2_address_proof_details.click()
}
...
async user_verify_guarantor_basic_information_title(){
    await expect(this.txt_guarantor_basic_information_title).toBeVisible();
}
...
async user_enters_net_taxable_income(strnettaxable: string){
  await this.playwrightFactory.fill(this.txt_less_deductions, strnettaxable);
}
...
async user_clicks_add_data_button_for_guarantor_company_id_details(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_guarantor_company_id_details);
}

async user_enters_company_name_in_details_in_guarantor_company_id_details(strcompany: string){
  await this.playwrightFactory.fill(this.txt_company_name_in_guarantor_company_id_details, strcompany);
}

async user_enters_address_name_in_details_in_guarantor_company_id_details(straddresscompanyid: string){
  await this.playwrightFactory.fill(this.txt_address_in_guarantor_company_id_details, straddresscompanyid);
}

async user_enters_employee_id_in_details_in_guarantor_company_id_details(stremployeeid: string){
  await this.playwrightFactory.fill(this.txt_employee_id_in_guarantor_company_id_details, stremployeeid);
}

async user_enters_employee_name_in_details_in_guarantor_company_id_details(stremployeename: string){
  await this.playwrightFactory.fill(this.txt_employee_name_in_guarantor_company_id_details, stremployeename);
}

async user_selects_joining_date_in_guarantor_company_id_details(strjoiningdate: string) {
await this.playwrightFactory.fill(this.txt_joining_date_in_guarantor_company_id_details, strjoiningdate)
}

async user_clicks_save_button_for_guarantor_company_id_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_gurantor_company_id_details);
}

async user_clicks_verify_button_for_gurantor_company_id_details(){
  await this.playwrightFactory.click(this.btn_verify_button_for_guarantor_company_id_details);
}

async user_clicks_add_data_button_for_guarantor_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_add_data_button_for_guarantor_bank_statement_details);
}

async user_clicks_add_a_line_button_for_guarantor_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_add_a_line_button_for_guarantor_bank_statement_details);
}

async user_enters_name_in_guarantor_bank_statement_details(strnamebankstement: string){
  await this.playwrightFactory.fill(this.txt_name_in_guarantor_bank_statement_details, strnamebankstement);
}

async user_enters_account_number_in_guarantor_bank_statement_details(straccount: string){
  await this.playwrightFactory.fill(this.txt_account_number_in_guarantor_bank_statement_details, straccount);
}

async user_enters_bank_balance_in_guarantor_bank_statement_details(strbankbalance: string){
  await this.playwrightFactory.fill(this.txt_bank_balance_in_guarantor_bank_statement_details, strbankbalance);
}

async user_enters_average_balance_in_guarantor_bank_statement_details(straveragebalance: string){
  await this.playwrightFactory.fill(this.txt_average_balance_in_guarantor_bank_statement_details, straveragebalance);
}

async user_enters_cb_mbc_ac_ecs_si_in_guarantor_bank_statement_details(strcb: string){
  await this.playwrightFactory.fill(this.txt_cb_mbc_ac_ecs_si_in_guarantor_bank_statement_details, strcb);
}

async user_clicks_save_button_for_guarantor_bank_statement_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_gurantor_bank_statement_details);
}

async user_clicks_verify_button_for_gurantor_bank_statement_details(){
