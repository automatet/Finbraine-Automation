...
readonly btn_guarantor2_computation_of_income_add_data_button: Locator;
 ...
 readonly txt_nature_of_service_in_detail_guarantor2:Locator;
 readonly txt_nature_of_service_in_detail:Locator;
 ...
 readonly guarantor2_bank_statement_add_data_btn: Locator;
  readonly guarantor2_bank_statement_details_add_line_btn: Locator;
  readonly guarantor2_bank_statement_details_name: Locator;
  readonly guarantor2_bank_statement_detail_account_no: Locator;
  readonly guarantor2_bank_statement_bank_balance: Locator;
  readonly guarantor2_bank_statement_avg_balance: Locator;
  readonly guarantor2_bank_statement_detail_cbmbc_field: Locator;
  readonly guarantor2_bank_statement_save_btn: Locator;
  //readonly bank_statement_details_table: Locator;
  readonly guarantor2_bank_statement_verify_btn: Locator;

  readonly guarantor2_added_other_income_details_add_data_btn:Locator;
  readonly guarantor2_added_other_income_details_add_line_btn:Locator;
  readonly guarantor2_added_other_income_details_month_fields_btn:Locator;
//readonly guarantor1_added_other_income_details_year:Locator;
  readonly guarantor2_added_other_income_details_amount:Locator;
  readonly guarantor2_added_other_income_details_save_btn:Locator;
//readonly guarantor1_verify_other_income_details_data:Locator;
  readonly guarantor2_other_income_details_verify_btn:Locator;

  readonly btn_Add_data_in_guarantor2_Membership_Details:Locator;
  readonly guarantor2_Membership_Number_in_Membership_Details:Locator;
  readonly guarantor2_Number_of_Shares_in_Membership_Details:Locator;
  readonly guarantor2_Shares_From_in_Membership_Details:Locator;
  readonly guarantor2_Existing_Shares_Amount_in_Membership_Details:Locator;
  readonly guarantor2_Total_Shares_Required_in_Membership_Details:Locator;
  readonly guarantor2_Additional_Shares_Required_in_Membership_Details:Locator;
  readonly btn_Save_in_guarantor2_Membership_Details:Locator;
  readonly checkbox_verify_in_guarantor2_Membership_Details:Locator;

  readonly btn_add_data_button_for_guarantor2_P_L_details:Locator;
 readonly btn_add_line_button_for_guarantor2_P_L_details:Locator;
 readonly P_L_statement_add_month_field_guarantor2:Locator;
readonly P_L_statement_year_field_guarantor2:Locator;
readonly P_L_statement_sales_field_guarantor2:Locator;
readonly P_L_statement_purchase_field_guarantor2:Locator;
readonly P_L_statement_net_profit_field_guarantor2:Locator;
readonly P_L_statement_interest_field_guarantor2:Locator;
readonly P_L_statement_income_tax_field_guarantor2:Locator;
readonly P_L_statement_other_income_tax_field_guarantor2:Locator;
readonly P_L_statement_agriculture_income_field_guarantor2:Locator;
readonly P_L_statement_TDS_field_guarantor2:Locator;
readonly P_L_statement_save_btn_guarantor2:Locator;
readonly P_L_statement_verify_btn_guarantor2:Locator;
readonly P_L_statement_depreciation_field_guarantor2:Locator;


readonly add_data_btn_ITR_details_guarantor_2:Locator;
  readonly add_line_btn_ITR_details_guarantor_2:Locator;
  readonly month_btn_ITR_details_guarantor_2:Locator;
  readonly year_btn_ITR_details_guarantor_2:Locator;
readonly total_income_btn_ITR_details_guarantor_2:Locator;
readonly total_taxes_interest_fee_btn_ITR_details_guarantor_2:Locator;
readonly taxes_paid_btn_ITR_details_guarantor_2:Locator;
readonly save_btn_ITR_details_guarantor_2:Locator;
readonly verify_btn_ITR_details_guarantor_2:Locator;

readonly guarantor2_basic_other_information_borrower_type_of_account_field:Locator;
readonly guarantor2_basic_other_information_borrower_type_of_account:Locator;
readonly guarantor2_basic_other_information_borrower_account_details:Locator;
readonly guarantor2_basic_other_information_borrower_account_balance:Locator;
readonly guarantor2_basic_other_information_borrower_loan_type_sanction_date:Locator;
readonly guarantor2_basic_other_information_borrower_sanction_amount:Locator;
readonly guarantor2_basic_other_information_borrower_expiry_date:Locator;
readonly guarantor2_basic_other_information_borrower_emi_start_date:Locator;
readonly guarantor2_basic_other_information_borrower_close_btn:Locator;
...
readonly guarantor_basic_other_information_borrower_emi_start_date:Locator;
 ...
 readonly eye_btn_pancard_enabled:Locator;
  ...
  constructor(container: any) {
    ...
    this.guarantor_basic_information_guarantor_name=this.page.locator('(//input[@name="guarantor1_name"])[2]')
    ...
    this.guarantor2_basic_information_guarantor_name=this.page.locator('(//input[@name="guarantor2_name"])[2]')
    ...
    this.txt_nature_of_service_in_detail=this.page.locator('//select[@name="wizard_guarantor1_nature_of_service_business"]')
    ...
    this.btn_verify_button_for_guarantor_business_details=this.page.locator('//div[@name="verify_guarantor1_balance_sheet_details"]')
    ...
    this.guarantor1_added_other_income_details_month_fields_btn= this.page.locator('//select[@name="wizard_year"')
    ...
    this.guarantor1_other_income_details_verify_btn= this.page.locator('//div[@name="verify_guarantor1_other_income_details"]')
...
this.checkbox_verify_in_guarantor_Membership_Details=this.page.locator('//div[@name="verify_guarantor_membership_details"]')
...
this.verify_btn_ITR_details=this.page.locator('//div[@name="verify_guarantor1_itr_details"]')
...
this.btn_add_data_button_for_guarantor2_business_details=this.page.locator("//button[@name='guarantor2_business_details_wizard']//span[contains(text(),'Add Data')]")
this.txt_name_of_the_firm_for_for_gurantor2_business_details=this.page.locator("//input[@name='wizard_guarantor2_business_name']")
this.txt_address_of_the_firm_gurantor2=this.page.locator("//input[@name='wizard_guarantor2_business_address']")
this.txt_type_of_ownership_gurantor2=this.page.locator("//input[@name='wizard_guarantor2_ownership']")
this.txt_nature_of_service_in_detail_guarantor2=this.page.locator('//select[@name="wizard_guarantor2_nature_of_service_business"]')
this.txt_nature_of_business_in_detail_gurantor2=this.page.locator("//input[@name='wizard_guarantor2_nature_of_business']")
this.btn_add_a_line_button_for_guarantor2_financials=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor2_business_details_ids']//*[contains(text(),'Add a line')]")
...
this.btn_verify_button_for_guarantor2_business_details=this.page.locator('//div[@name="verify_guarantor2_balance_sheet_details"]')

this.guarantor2_bank_statement_add_data_btn= this.page.locator('//button[@name="guarantor2_bank_statement_wizard"]');
    this.guarantor2_bank_statement_details_add_line_btn= this.page.locator('//*[contains(text(),"Add a line")]/following::div[@name="guarantor2_bank_statement_ids"]//*[contains(text(),"Add a line")]');
    this.guarantor2_bank_statement_details_name= this.page.locator("//input[@name='wizard_name']");
    this.guarantor2_bank_statement_detail_account_no= this.page.locator("//input[@name='wizard_ac_no']");
    this.guarantor2_bank_statement_bank_balance= this.page.locator("//input[@name='wizard_bank_balance']");
    this.guarantor2_bank_statement_avg_balance= this.page.locator("//input[@name='wizard_avg_balance']");
    this.guarantor2_bank_statement_detail_cbmbc_field= this.page.locator("//input[@name='wizard_cb_mbc_ac_ecs_si']");
    this.guarantor2_bank_statement_save_btn= this.page.locator('//button[@name="save_guarantor2_bank_statement_wizard"]');
    //this.bank_statement_details_table= this.page.locator("//tbody[@class='ui-sortable']/ancestor::div[@name='bank_statement_details_ids']");
    this.guarantor2_bank_statement_verify_btn= this.page.locator('//div[@name="verify_guarantor2_bank_statement_details"]');

    this.guarantor2_added_other_income_details_add_data_btn= this.page.locator('//button[@name="guarantor2_other_income_wizard"]')
    this.guarantor2_added_other_income_details_add_line_btn= this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor2_other_income_ids']//*[contains(text(),'Add a line')]") 
    this.guarantor2_added_other_income_details_month_fields_btn= this.page.locator('//select[@name="wizard_year"]')
    //this.guarantor1_added_other_income_details_year= this.page.locator("//select[@name='wizard_month']")
    this.guarantor2_added_other_income_details_amount= this.page.locator("//input[@name='wizard_amount']")
    this.guarantor2_added_other_income_details_save_btn= this.page.locator('//button[@name="save_guarantor2_other_income_wizard"]')
    //this.guarantor1_verify_other_income_details_data= this.page.locator("//div[@name='other_income_ids']")
    this.guarantor2_other_income_details_verify_btn= this.page.locator('//div[@name="verify_guarantor2_other_income_details"]')

    this.btn_Add_data_in_guarantor2_Membership_Details=this.page.locator('//button[@name="guarantor2_membership_details_wizard"]')
    this.guarantor2_Membership_Number_in_Membership_Details=this.page.locator('//input[@name="wizard_guarantor2_membership_number"]')
    this.guarantor2_Number_of_Shares_in_Membership_Details=this.page.locator('//input[@name="wizard_guarantor2_no_of_shares"]')
    this.guarantor2_Shares_From_in_Membership_Details=this.page.locator('//input[@name="wizard_guarantor2_share_from"]')  
    this.guarantor2_Existing_Shares_Amount_in_Membership_Details=this.page.locator('//input[@name="wizard_guarantor2_existing_share_amt"]')  
    this.guarantor2_Total_Shares_Required_in_Membership_Details=this.page.locator('//input[@name="wizard_guarantor2_total_share_req"]')
    this.guarantor2_Additional_Shares_Required_in_Membership_Details=this.page.locator('//input[@name="wizard_guarantor2_additional_share_req"]')
    this.btn_Save_in_guarantor2_Membership_Details=this.page.locator('//button[@name="save_guarantor2_membership_details"]')
    this.checkbox_verify_in_guarantor2_Membership_Details=this.page.locator('//div[@name="verify_guarantor2_membership_details"]')

    this.btn_add_data_button_for_guarantor2_P_L_details=this.page.locator('//button[@name="guarantor2_income_details_wizard"]')
    this.btn_add_line_button_for_guarantor2_P_L_details=this.page.locator("//*[contains(text(),'Add a line')]/following::div[@name='guarantor2_income_details_ids']//*[contains(text(),'Add a line')]")
    this.P_L_statement_add_month_field_guarantor2=this.page.locator('//select[@name="wizard_month"]')
    this.P_L_statement_year_field_guarantor2=this.page.locator('//select[@name="wizard_year"]')
    this.P_L_statement_sales_field_guarantor2=this.page.locator('//input[@name="wizard_sales"]')
    this.P_L_statement_purchase_field_guarantor2=this.page.locator('//input[@name="wizard_purchases"]')
    this.P_L_statement_net_profit_field_guarantor2=this.page.locator('//input[@name="wizard_net_profit"]')
    this.P_L_statement_depreciation_field_guarantor2=this.page.locator('//input[@name="wizard_depreciation"]')

    this.P_L_statement_interest_field_guarantor2=this.page.locator('//input[@name="wizard_interest"]')                           
    this.P_L_statement_income_tax_field_guarantor2=this.page.locator('//input[@name="wizard_income_tax"]')
    this.P_L_statement_other_income_tax_field_guarantor2=this.page.locator('//input[@name="wizard_other_income"]')
    this.P_L_statement_agriculture_income_field_guarantor2=this.page.locator('//input[@name="wizard_agricultural_income"]')
    this.P_L_statement_TDS_field_guarantor2=this.page.locator('//input[@name="wizard_tds"]')
    this.P_L_statement_save_btn_guarantor2=this.page.locator('//button[@name="save_guarantor2_income_details_wizard"]')
    this.P_L_statement_verify_btn_guarantor2=this.page.locator('//div[@name="verify_guarantor2_p_and_l_statement_details"]')

    this.add_data_btn_ITR_details_guarantor_2=this.page.locator('//button[@name="guarantor2_itr_business_details_wizard"]')
this.add_line_btn_ITR_details_guarantor_2=this.page.locator('//*[contains(text(),"Add a line")]/following::div[@name="guarantor2_itr_business_details_table_ids"]//*[contains(text(),"Add a line")]')
this.month_btn_ITR_details_guarantor_2=this.page.locator('//select[@name="wizard_month"]')
this.year_btn_ITR_details_guarantor_2=this.page.locator('//select[@name="wizard_year"]')
this.total_income_btn_ITR_details_guarantor_2=this.page.locator('//input[@name="wizard_total_income"]')
this.total_taxes_interest_fee_btn_ITR_details_guarantor_2=this.page.locator('//input[@name="wizard_total_taxes_interest_fee_payable"]')
this.taxes_paid_btn_ITR_details_guarantor_2=this.page.locator('//input[@name="wizard_taxes_paid"]')
this.save_btn_ITR_details_guarantor_2=this.page.locator('//button[@name="save_guarantor2_itr_business_details"]')
this.verify_btn_ITR_details_guarantor_2=this.page.locator('//div[@name="verify_guarantor2_itr_details"]')

this.guarantor2_basic_other_information_borrower_type_of_account_field=this.page.locator("(//td[contains(@class,'o_data_cell') and @title='SBA'])[2]")
this.guarantor2_basic_other_information_borrower_type_of_account=this.page.locator('//span[@name="borrower_type_of_account"]')
this.guarantor2_basic_other_information_borrower_account_details=this.page.locator('//span[@name="borrower_account_details"]')
this.guarantor2_basic_other_information_borrower_account_balance=this.page.locator('//span[@name="borrower_account_balance"]')
this.guarantor2_basic_other_information_borrower_loan_type_sanction_date=this.page.locator('//span[@name="sanction_date"]')
this.guarantor2_basic_other_information_borrower_sanction_amount=this.page.locator('//span[@name="sanction_amount"]')
this.guarantor2_basic_other_information_borrower_expiry_date=this.page.locator('//span[@name="expiry_date"]')
this.guarantor2_basic_other_information_borrower_emi_start_date=this.page.locator('//span[@name="emi_start_date"]')
this.guarantor2_basic_other_information_borrower_close_btn=this.page.locator('//*[contains(text(),"Close")]')
}
  


 async user_enter_guarantor_basic_information_mobile_number(strname: string){
    await this.playwrightFactory.fill(this.guarantor_basic_information_mobile_number, strname)
...
async user_enter_guarantor_basic_information_guarantor_gender(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_gender, strname)


}
async user_enter_guarantor_basic_information_guarantor_cif_number(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_cif_number, strname)


}
async user_enter_guarantor_basic_information_guarantor_branch_code(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_branch_code, strname)

}
async user_enter_guarantor_basic_information_guarantor_ckyc_number(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_ckyc_number, strname)

}
async user_enter_guarantor_basic_information_guarantor_member_number(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_member_number, strname)

}
async user_enter_guarantor_basic_information_guarantor_banking_relations_with_us_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_banking_relations_with_us_field, strname)

}
async user_enter_guarantor_basic_information_guarantor_account_balance(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_account_balance, strname)
}
async user_enter_guarantor_basic_information_guarantor_saving_current_number(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_saving_current_number, strname)
}
...
async user_enter_guarantor_basic_information_guarantor_kyc_date(strname: string){
  await this.playwrightFactory.fill(this.guarantor_basic_information_guarantor_kyc_date, strname)
}
...
async user_enter_guarantor1_pan_name_id_document(strname: string) {
  await (this.guarantor1_pan_name_id_document).click()
...
async user_enters_nature_of_business_in_details_in_guarantor_business_details(strownership: string){
  await this.playwrightFactory.fill(this.txt_nature_of_business_in_detail, strownership);

}
async user_enters_nature_of_service_in_details_in_guarantor_business_details(){
  await (this.txt_nature_of_service_in_detail).click()
  await this.txt_nature_of_service_in_detail.selectOption({label:'Service in Semi Government Department'});
}
...
async user_click_guarantor1_income_details_month_field_btn(){
  await (this.guarantor1_added_other_income_details_month_fields_btn).click()
  await this.guarantor1_added_other_income_details_month_fields_btn.selectOption({label:'2026'})
}
...
async user_click_guarantor2_other_income_details_add_data_btn(){
  await this.playwrightFactory.click(this.guarantor2_added_other_income_details_add_data_btn);
}
 
async user_click_guarantor2_income_details_add_line_btn(){
  await this.playwrightFactory.click(this.guarantor2_added_other_income_details_add_line_btn);
}
async user_click_guarantor2_income_details_month_field_btn(){
  await this.guarantor2_added_other_income_details_month_fields_btn.selectOption({label:'2025'})
}
 
 
async user_enter_guarantor2_amount_in_other_income_details(stramount: string){
  await this.playwrightFactory.fill(this.guarantor2_added_other_income_details_amount, stramount);
}
 
async user_clicks_guarantor2_income_details_save_btn(){
  await this.playwrightFactory.click(this.guarantor2_added_other_income_details_save_btn);
}

async user_clicks_guarantor2_income_details_verify_btn(){
  await this.playwrightFactory.click(this.guarantor2_other_income_details_verify_btn);
}
...
async user_select_guarantor2_basic_information_guarantor_profile_type(){
  await this.guarantor2_basic_information_guarantor_profile_type.selectOption({label:'Business'})
}
async user_enter_guarantor2_basic_information_guarantor_gender(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_gender, strname)

}
async user_enter_guarantor2_basic_information_guarantor_cif_number(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_cif_number, strname)
}
async user_enter_guarantor2_basic_information_guarantor_branch_code(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_branch_code, strname)
}
async user_enter_guarantor2_basic_information_guarantor_ckyc_number(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_ckyc_number, strname)
}

async user_enter_guarantor2_basic_information_guarantor_member_number(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_member_number, strname)
}
async user_enter_guarantor2_basic_information_guarantor_banking_relations_with_us_field(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_banking_relations_with_us_field, strname)
}
async user_enter_guarantor2_basic_information_guarantor_account_balance(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_account_balance, strname)
}
async user_enter_guarantor2_basic_information_guarantor_saving_current_number(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_saving_current_number, strname)
}

async user_select_guarantor2_basic_information_guarantor_director_relative(){
  await this.guarantor2_basic_information_guarantor_director_relative.selectOption({label:'Yes'});
}
async user_enter_guarantor2_basic_information_guarantor_kyc_date(strname: string) {
  await this.playwrightFactory.fill(this.guarantor2_basic_information_guarantor_kyc_date, strname)
}
...
async user_enters_nature_of_business_in_details_in_guarantor2_business_details(strownership: string){
  await this.playwrightFactory.fill(this.txt_nature_of_business_in_detail_gurantor2, strownership);

}
async user_enters_nature_of_service_in_details_in_guarantor2_business_details(){
  await this.txt_nature_of_service_in_detail_guarantor2.selectOption({label:'Service in Semi Government Department'});
}
...
async user_select_year_in_guarantor2_financials_balance_sheet() {
  await this.txt_year_in_guarantor2_financials_balance_sheet.selectOption({label:'2025'});
}
...
async user_click_guarantor2_add_data_btn_for_bank_statement(){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_add_data_btn);
}
async user_click_guarantor2_add_line_btn_for_bank_statement_details(){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_details_add_line_btn);
}
async user_enter_guarantor2_name_in_bank_statement_section(strName: string){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_details_name)
  await this.playwrightFactory.fill(this.guarantor2_bank_statement_details_name, strName);
}
async user_enter_guarantor2_accont_no_in_bank_statement_section(strAccount: string){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_detail_account_no);
  await this.playwrightFactory.fill(this.guarantor2_bank_statement_detail_account_no,strAccount);
}
async user_enter_guarantor2_bank_balance_bank_statement_section(strBalnce: string){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_bank_balance)
  await this.playwrightFactory.fill(this.guarantor2_bank_statement_bank_balance, strBalnce);
}
async user_enter_guarantor2_avg_balance_in_bank_statement_section(strAvg: string){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_avg_balance);
  await this.playwrightFactory.fill(this.guarantor2_bank_statement_avg_balance,strAvg);
}
async user_enter_guarantor2_cb_mbc_field(strCb: string){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_detail_cbmbc_field);
  await this.playwrightFactory.fill(this.guarantor2_bank_statement_detail_cbmbc_field, strCb);
}
async user_click_guarantor2_save_btn_for_bank_statement_section(){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_save_btn);
}

async user_click_guarantor2_verify_btn_for_bank_statement_section(){
  await this.playwrightFactory.click(this.guarantor2_bank_statement_verify_btn);
}


async user_clicks_Add_data_in_guarantor2_Membership_Details(){
  await this.btn_Add_data_in_guarantor2_Membership_Details.click()
  }
  async user_enters_guarantor2_Membership_Number_in_Membership_Details(strno:string){
  await this.guarantor2_Membership_Number_in_Membership_Details.fill(strno)
  }
   
  async user_enters_Number_of_Shares_in_guarantor2_Membership_Details(strsharesno:string){
  await this.guarantor2_Number_of_Shares_in_Membership_Details.fill(strsharesno)  
   
  }
  async user_enters_guarantor2_Shares_From_in_Membership_Details(strsharesdate:string){
  await this.guarantor2_Shares_From_in_Membership_Details.fill(strsharesdate)  
   
  }
  async user_enters_guarantor2_Existing_Shares_Amount_in_Membership_Details(strexistingshares:string){
    await this.guarantor2_Existing_Shares_Amount_in_Membership_Details.fill(strexistingshares)
   
  }
  async user_enters_guarantor2_Total_Shares_Required_in_Membership_Details(strtotalshares:string){
    await this.guarantor2_Total_Shares_Required_in_Membership_Details.fill(strtotalshares)
   
  }
  async user_enters_Additional_Shares_Required_in_guarantor2__Membership_Details(straddshares:string){
  await this.guarantor2_Additional_Shares_Required_in_Membership_Details.fill(straddshares)  
   
  }
  async user_clicks_Save_in_guarantor2__Membership_Details(){
    await this.btn_Save_in_guarantor2_Membership_Details.click()
   
  }
  async user_clicks_verify_in_guarantor2_Membership_Details(){
    await this.checkbox_verify_in_guarantor2_Membership_Details.click()
   
  }
  async user_click_btn_add_data_button_for_guarantor2_P_L_details(){
    await this.btn_add_data_button_for_guarantor2_P_L_details.click()
  }
  async user_click_btn_add_line_button_for_guarantor2_P_L_details(){
    await this.btn_add_line_button_for_guarantor2_P_L_details.click()
  }
  
  async user_select_add_month_field_in_guarantor2_pl_statement(){
    await this.P_L_statement_add_month_field_guarantor2.selectOption({label:'January'});
  }
  async user_select_year_field_in_pl_statement_guarantor2(){
    await this.P_L_statement_year_field_guarantor2.selectOption({label:'2025'});
  }
  ...
  async user_enters_sales_field_in_guarantor2__pl_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_sales_field_guarantor2, strname);
  }
  async user_enters_purchase_field_in_guarantor2_pl_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_purchase_field_guarantor2, strname);
  }
  async user_enters_net_profit_field_in_pl_guarantor2_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_net_profit_field_guarantor2, strname);
  }
  
  
  async user_enters_depreciation_field_in_pl_guarantor2_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_depreciation_field_guarantor2, strname);
  }
  async user_enters_interest_field_in_guarantor2_pl_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_interest_field_guarantor2, strname);
  }
  
  async user_enters_income_tax_field_in_pl_guarantor2_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_income_tax_field_guarantor2, strname);
  }
  
  async user_enters_other_income_tax_field_in_pl_guarantor2_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_other_income_tax_field_guarantor2, strname);
  
  }
  async user_enters_agriculture_income_field_in_pl_guarantor2_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_agriculture_income_field_guarantor2, strname);
  
  }
  async user_enters_TDS_field_in_pl_guarantor2_statement(strname: string){
    await this.playwrightFactory.fill(this.P_L_statement_TDS_field_guarantor2, strname);
  
  }
  
  async user_click_guarantor2_pl_save_btn(){
    await this.playwrightFactory.click(this.P_L_statement_save_btn_guarantor2);
  }
  
  async user_click_guarantor2_pl_verify_btn(){
    await this.playwrightFactory.click(this.P_L_statement_verify_btn_guarantor2);
  }
  

  async user_click_guarantor2_add_data_btn_ITR_details(){
    await this.playwrightFactory.click(this.add_data_btn_ITR_details_guarantor_2);
  }
  async user_click_guarantor2_add_line_btn_ITR_details(){
    await this.playwrightFactory.click(this.add_line_btn_ITR_details_guarantor_2);
  }

  async user_select_guarantor2_ITR_details_month_field(){
    await this.month_btn_ITR_details_guarantor_2.selectOption({label:'January'});
}
async user_select_guarantor2_ITR_details_year_field(){
  await this.year_btn_ITR_details_guarantor_2.selectOption({label:'2025'});
}
async user_enters_guarantor2_income_in_ITR_details_field(strname: string){
  await this.playwrightFactory.fill(this.total_income_btn_ITR_details_guarantor_2, strname);
}
async user_enters_guarantor2_total_taxes_fees_in_ITR_details_field(strname: string){
  await this.playwrightFactory.fill(this.total_taxes_interest_fee_btn_ITR_details_guarantor_2, strname);
}
async user_enters_guarantor2_taxes_paid_in_ITR_details_field(strname: string){
  await this.playwrightFactory.fill(this.taxes_paid_btn_ITR_details_guarantor_2, strname);
}
async user_click_guarantor2_save_btn_ITR_details(){
  await this.playwrightFactory.click(this.save_btn_ITR_details_guarantor_2);
}
async user_click_guarantor2_verify_btn_ITR_details(){
  await this.playwrightFactory.click(this.verify_btn_ITR_details_guarantor_2);
}
...
async user_click_guarantor2_business_certificate_details_add_data_btn(){
  await this.guarantor2_business_certificate_details_add_data_btn.click()
}
async user_enter_guarantor2_business_certificate_details_name_of_firm_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_name_of_firm_field, strname)
}

async user_enter_guarantor2_business_certificate_details_shop_act_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_shop_act_field, strname)
}
async user_enter_guarantor2_business_certificate_details_name_of_owner_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_name_of_owner_field, strname)
}

async user_enter_guarantor2_business_certificate_details_type_of_business_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_type_of_business_field, strname)
}
async user_enter_guarantor2_business_certificate_details_udhayam_name_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_udhayam_name_field, strname)
}
async user_enter_guarantor2_business_certificate_details_udhayam_nunber_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_udhayam_nunber_field, strname)
}
async user_enter_guarantor2_business_certificate_details_no_of_year_business_field(strname: string){
  await this.playwrightFactory.fill(this.guarantor2_business_certificate_details_no_of_year_business_field, strname)
}
async user_click_save_btn_guarantor2_business_certificate_details(){
  await this.save_btn_guarantor2_business_certificate_details_field.click()
}

async user_click_verify_btn_guarantor2_business_certificate_details(){
  await this.verify_btn_guarantor2_business_certificate_details_field.click()
}
