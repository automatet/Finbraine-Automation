...
export class Gold_Loan_Loan_Application_Tab_Page {
  private page: Page;
  ...
  readonly agriculture_income: Locator;
 ...
 readonly txt_gold_valuation_fee: Locator;
 readonly txt_gold_audit_fee: Locator;
 ...
 readonly txt_nominee_information_title: Locator;
 readonly txt_name_in_nominee_information_field: Locator;
 readonly txt_age_in_nominee_information: Locator;
 readonly txt_mobile_number_in_nominee_information: Locator;
 ...
 readonly txt_add_a_line_button_for_gold_valuation_certificate: Locator;
 readonly txt_serial_number_in_gold_valuation_certificate: Locator;
 readonly txt_particular_description_in_gold_valuation_certificate: Locator;
 readonly txt_quantity_in_gold_valuation_certificate: Locator;
 readonly txt_gross_weight_in_gold_valuation_certificate: Locator;
 readonly txt_purity_in_gold_valuation_certificate: Locator;
 readonly txt_after_verification_of_purity_in_gold_valuation_certificate: Locator;
 ...
 readonly btn_reupload_docs_button:Locator;
  ...
  readonly added_verify_by_name: Locator;
  readonly added_verify_by_designation: Locator;
  readonly added_verify_by_comment: Locator;
  readonly added_date_of_verification: Locator;
  readonly added_verify_by_signature: Locator;
  ...
  constructor(container: any) {
    ...
    this.txt_gold_valuation_fee=this.page.locator("//input[@name='wizard_gold_valuation_fees']")
    this.txt_Stamp_Charges_in_Charge_details  = this.page.locator('//input[@name="wizard_stamp_charges"]')
    this.txt_gold_audit_fee=this.page.locator("//input[@name='wizard_gold_audit_fees']")
    ...
    this.txt_nominee_information_title=this.page.locator("//span[normalize-space()='Nominee Information']")
    this.txt_name_in_nominee_information_field=this.page.locator("//input[@name='nominee_name']")
    this.txt_age_in_nominee_information=this.page.locator("//input[@name='nominee_age']")
    this.txt_mobile_number_in_nominee_information=this.page.locator("//input[@name='nominee_mobile_number']")
    this.txt_relation_with_applicant_in_nominee_information=this.page.locator("//input[@name='nominee_relation_with_applicant']")
    this.txt_gender_in_nominee_information=this.page.locator("//select[@name='nominee_gender']")
    this.txt_address_in_nominee_information=this.page.locator("//input[@name='nominee_address']")
    this.txt_gold_ornaments_details_title=this.page.locator("//span[normalize-space()='Gold Ornaments Details']")
    this.txt_add_data_button_in_gold_ornaments_details=this.page.locator("//button[@name='gold_valuation_details_wizard']")
    ...
    this.txt_after_verification_of_purity_in_gold_valuation_certificate=this.page.locator("//input[@name='wizard_after_verification_of_purity']")
    ...
    this.added_total_quotation_amount= this.page.locator("//span[@name='customer_quotation_amt']")
    ...
    this.added_verify_by_name= this.page.locator("//span[@name='customer_name_q']")
    this.added_verify_by_designation= this.page.locator("//span[@name='customer_designation']")
    this.added_verify_by_comment= this.page.locator("//span[@name='comment_section']")
    this.added_date_of_verification= this.page.locator("//span[@name='date_of_verification']")
    this.added_verify_by_signature= this.page.locator("//span[@name='customer_signature']")
...
async user_verify_other_income(){
  await expect(this.other_income).toBeVisible();
}

async user_verify_agriculture_income(){
...
await this.playwrightFactory.fill(this.txt_gold_custody_charges,strgoldcustody)
}
...
async user_enters_gold_valuation_fee(strgoldvaluationfee:string){
  await this.playwrightFactory.fill(this.txt_gold_valuation_fee,strgoldvaluationfee);
}

async user_enters_gold_audit_fee(strgoldauditfee:string){
  await this.playwrightFactory.fill(this.txt_gold_audit_fee,strgoldauditfee);
}
...
async user_verify_nominee_information_title(){
  await expect(this.txt_nominee_information_title).toBeVisible();
}

async user_verify_name_in_nominee_information_field(){
  await expect(this.txt_name_in_nominee_information_field).not.toBeEmpty();
}

async user_verify_age_in_nominee_information_field(){
  await expect(this.txt_age_in_nominee_information).not.toBeEmpty();
}

async user_verify_mobile_number_in_nominee_information_field(){
  await expect(this.txt_mobile_number_in_nominee_information).not.toBeEmpty();
}

async user_verify_relation_with_applicant_in_nominee_information_field(){
  await expect(this.txt_relation_with_applicant_in_nominee_information).not.toBeEmpty();
}

async user_verify_gender_in_nominee_information_field(){
  await expect(this.txt_gender_in_nominee_information).not.toBeEmpty();
}

async user_verify_address_in_nominee_information_field(){
  await expect(this.txt_address_in_nominee_information).not.toBeEmpty();
}

async user_verify_gold_ornaments_details_title(){
  await expect(this.txt_gold_ornaments_details_title).toBeVisible();
}

async user_clicks_add_data_button_for_gold_ornaments_details(){
  await this.playwrightFactory.click(this.txt_add_data_button_in_gold_ornaments_details);
}

async user_verify_gold_valuation_certificate_title(){
  await expect(this.txt_gold_valuation_certificate_title).toBeVisible();
}

async user_click_add_a_line_button_in_gold_ornaments_valuation_details(){
  await this.playwrightFactory.click(this.txt_add_a_line_button_for_gold_valuation_certificate);
}

async user_enters_serial_number_in_gold_valuation_certificate(strserialnumber:string){
...
async user_enters_gross_weight_in_gold_valuation_certificate(strgrossweight:string){
await this.playwrightFactory.fill(this.txt_gross_weight_in_gold_valuation_certificate,strgrossweight)
}

async user_enters_purity_in_gold_valuation_certificate(strpurity:string){
await this.playwrightFactory.fill(this.txt_purity_in_gold_valuation_certificate,strpurity)
}

async user_enters_after_verification_of_purity_in_gold_valuation_certificate(strverification:string){
await this.playwrightFactory.fill(this.txt_after_verification_of_purity_in_gold_valuation_certificate,strverification)
}

async user_enters_net_weight_in_gold_valuation_certificate(strnetweight:string){
await this.playwrightFactory.fill(this.txt_net_weight_in_gold_valuation_certificate,strnetweight)
}
...
async user_enters_date_of_valuation_in_gold_valuation_certificate(strdateofvaluation:string){
await this.playwrightFactory.fill(this.txt_date_of_valuation,strdateofvaluation)
}

async user_enters_gold_valuer_name_in_gold_valuation_certificate(strgoldvaluername:string){
await this.playwrightFactory.fill(this.txt_gold_valuer_name,strgoldvaluername)
}

async user_clicks_save_button_in_gold_ornaments_valuation_details(){
  await this.playwrightFactory.click(this.btn_save_button_for_gold_loan);
}

async user_clicks_verify_btn_in_gold_ornaments_details(){
  //await this.page.waitForTimeout(500)
  await this.playwrightFactory.click(this.btn_gold_ornaments_details_verify_button)
}

async user_enter_comment_in_branch_manager_recommendation_and_remark(strcomment: string){
  await this.playwrightFactory.fill(this.txt_branch_manager_recommendation_remark_comment_field, strcomment);
}
 
async user_enter_name_in_absence_of_branch_manager_field(strnamecomment: string){
  await this.playwrightFactory.fill(this.txt_name_in_absence_of_branch_manager, strnamecomment);
}
 
async user_enter_comment_in_absence_of_branch_manager_field(strabsencecomment: string){
  await this.playwrightFactory.fill(this.txt_comment_in_absence_of_branch_manager, strabsencecomment);
}

async user_click_verified_btn(){
  await this.page.waitForTimeout(1000);
  await this.playwrightFactory.click(this.btn_verified_button);
}
...
async user_select_agriculture_income_year(){
  await this.playwrightFactory.click(this.agriculture_income_year);
}
 
 
async user_select_agriculture_income_ammount(strammount: string){
